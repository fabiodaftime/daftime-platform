...
export default function LandingEcommerce() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Modale RDV — montée uniquement à l'ouverture (pas d'overlay permanent → aucun blocage de
          scroll sur mobile). Le preconnect cal.com (index.html) accélère le chargement ; un spinner
          derrière l'iframe donne un retour visuel pendant le chargement. */}
      {bookingOpen && (
