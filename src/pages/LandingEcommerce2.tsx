...
const FAQ = [
  ...
  { q: 'Je peux le faire avec l’IA, non ?', a: 'La visualisation, oui — c’est la couche facile. Le vrai enjeu est dessous : réconcilier tes sources et mapper ta structure comme il faut. Un mapping bancal, et l’IA visualise impeccablement… du faux. Ce que tu paies, c’est un expert qui structure ta data, l’analyse, te l’explique et te dit quoi suivre — marge, ROAS, AOV face à ton secteur — puis t’oriente vers le bon levier (emailing, TikTok Shop, Google Ads). De l’expertise, du temps, du conseil, de l’aide au pilotage : le job d’un directeur financier, pour le prix de moins d’une journée du sien par mois.' },
