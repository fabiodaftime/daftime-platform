...
const DIGIT_FEB = {
  ...
  // CT costs
  ctCostsKPIs: [
    { label: "CA Comment/Trust", value: "$636", sub: "Services annexes", type: "primary" },
    { label: "Cost Product CT", value: "$0", sub: "0% du CA CT", type: "warning" },
    { label: "COM Sales CT", value: "$224", sub: "35.2% du CA CT", type: "accent" },
    { label: "Marge CT", value: "$412", sub: "64.8% du CA CT", type: "success" },
  ],
  ctCostsBreakdown: [
    { label: "CA Comment/Trust", value: "$636", negative: false },
    { label: "Cost Product", value: "$0", negative: false },
    { label: "COM Blink", value: "$0", negative: false },
    { label: "COM Sales", value: "-$224", negative: true },
  ],
  ctCostsTotal: "$412",
  // Revenue tab
  revenueKPIs: [
    { label: "CA Setup", value: "$79,141", sub: "233 deals • $340/deal", type: "primary" },
    { label: "CA Ad Account", value: "$25,309", sub: "43 deals • $588/deal", type: "success" },
    { label: "CA SPY", value: "$27,300", sub: "Produit SPY", type: "accent" },
    { label: "CA Comment/Trust", value: "$636", sub: "Services annexes", type: "warning" },
  ],
  revenueComparison: {
    setup: "$77,409 (Jan) → $79,141 (Fev) = +2.2%",
    ad: "$27,305 (Jan) → $25,309 (Fev) = -7.3%",
    spy: "$16,750 (Jan) → $27,300 (Fev) = +63.0% 🚀",
    ct: "$2,813 (Jan) → $636 (Fev) = -77.4% ⚠️",
  },
  revenueDistribution: [
    { name: "Setup", value: 79141 },
    { name: "Ad Account", value: 25309 },
    { name: "SPY", value: 27300 },
    { name: "Comment/Trust", value: 636 },
  ],
  // Products tab
  digitCoreKPIs: [
    { label: "CA Global", value: "$122,330", sub: "276 deals (Setup + Ad Account)", type: "primary" },
    { label: "Company Margin", value: "$44,249", sub: "36.2% du CA", type: "success" },
    { label: "Setup", value: "$79,141", sub: "233 deals • $340/deal", type: "accent" },
  ...
  ctKPIs: [
    { label: "CA Comment/Trust", value: "$636", sub: "", type: "warning", chg: "-77.4%" },
    { label: "Marge", value: "$412", sub: "64.8% du CA CT", type: "warning" },
  ],
  ctAlert: "Baisse marquée du CA Comment/Trust en février (-77.4% vs janvier). Le CA passe de $2,813 à $636 (Marge $412). À surveiller.",
  // YTD tab
  ytdMainKPIs: [
    { label: "CA Total YTD", value: "$284,478", sub: "2 mois • 501 deals" },
    { label: "Marge Totale YTD", value: "$95,212", sub: "33.5% du CA" },
    { label: "Taux de Marge Moyen", value: "33.5%", sub: "Performance globale YTD" },
    { label: "Ticket Moyen YTD", value: "$568", sub: "Sur 501 deals" },
  ],
  ytdMonthlyKPIs: [
    { label: "Janvier 2026", value: "$134,212", sub: "CA • 225 deals • Marge $46,992", type: "primary" },
    { label: "Février 2026", value: "$150,266", sub: "CA • 276 deals • Marge $48,220", type: "success" },
    { label: "Croissance CA", value: "+12.0%", sub: "Février vs Janvier", type: "accent" },
    { label: "Croissance Marge", value: "+2.6%", sub: "Février vs Janvier", type: "warning" },
  ],
  ytdProductKPIs: [
    { label: "Digit Solution", value: "$236,979", sub: "Marge $85,447 (36.1%)", type: "primary" },
    { label: "SPY", value: "$44,050", sub: "Marge $6,821", type: "success" },
    { label: "Comment/Trust", value: "$3,449", sub: "Marge $2,943", type: "warning" },
  ],
  ytdEvolutionData: [
  ...
  ytdProductDistribution: [
    ...
    { name: "Comment/Trust", value: 3449 },
  ],
  // Evolution MoM tab
  evolutionKPIs: [
    { label: "CA Total Growth", value: "+12.0%", sub: "+$16,054", detail: "Jan: $134,212 → Feb: $150,266", type: "primary" },
    { label: "Margin Growth", value: "+2.6%", sub: "+$1,228", detail: "Jan: $46,992 → Feb: $48,220", type: "success" },
    { label: "Deals Evolution", value: "+22.7%", sub: "+51 deals", detail: "Jan: 225 → Feb: 276", type: "success" },
    { label: "Ticket Moyen Growth", value: "-8.7%", sub: "-$52", detail: "Jan: $596 → Feb: $544", type: "warning" },
  ],
  evolutionProductKPIs: [
    ...
    { label: "Comment/Trust", value: "-77.4%", sub: "-$2,177 ⚠️", detail: "Jan: $2,813 → Feb: $636", type: "warning" },
  ],
  evolutionChartData: [12.0, 2.6, 22.7, 6.7, 63.0, -77.4],
  evolutionInsights: {
    positives: [
      "CA en hausse de 12.0% (+$16,054)",
      "SPY en forte croissance (+63%, +$10,550)",
      "Volume deals +22.7% (+51 deals) — meilleur volume du Q1",
      "Digit Solution en progression (+6.7%, +$7,681)",
      "Marge totale en progression (+2.6%, +$1,228)",
    ],
    warnings: [
      "Ticket moyen en repli (-8.7%, -$52)",
      "Comment/Trust en forte chute (-77.4%, -$2,177)",
    ],
    conclusion: "Performance globale positive portée par SPY et la hausse du volume de deals, vigilance sur l'érosion du ticket moyen et la performance de Comment/Trust.",
  },
};
...
const DIGIT_MAR = {
  ...
  overviewChartData: { labels: ['Février', 'Mars'], ca: [150266, 158668], marge: [48220, 61832] },
  comparisonM1: [
    { label: "CA Février", value: "$150,266", sub: "276 deals", type: "primary" },
    { label: "Marge Février", value: "$48,220", sub: "32.1% du CA", type: "success" },
    { label: "Évolution CA", value: "+5.6%", sub: "+$8,402", type: "success" },
    { label: "Évolution Marge", value: "+28.2%", sub: "+$13,612", type: "success" },
  ] as any[] | null,
  // Costs tab
  costsKPIs: [
...
const DIGIT_MAY = {
  ...
  overviewKPIs: [
    ...
    { label: "Marge Totale", value: "$30,296", sub: "29.3% du CA", type: "success" },
  ...
  overviewProducts: [
    { label: "Digit Solution (Core)", value: "$102,920", sub: "Marge $30,016 (29.2%)", type: "primary", chg: "-8.9%" },
  ...
  ytdMainKPIs: [
    { label: "CA Total YTD", value: "$698,444", sub: "5 mois • 1,452 deals (SPY Mai exclu)" },
    { label: "Marge Totale YTD", value: "$232,925", sub: "33.4% du CA" },
    { label: "Taux de Marge Moyen", value: "33.4%", sub: "Performance globale YTD" },
    { label: "Ticket Moyen YTD", value: "$481", sub: "Sur 1,452 deals" },
  ],
  ytdMonthlyKPIs: [
    { label: "Janvier 2026", value: "$134,212", sub: "CA • 225 deals • Marge $46,992", type: "primary" },
    { label: "Février 2026", value: "$150,266", sub: "CA • 276 deals • Marge $48,220", type: "success" },
    { label: "Mars 2026", value: "$158,668", sub: "CA • 288 deals • Marge $61,832", type: "accent" },
    { label: "Avril 2026", value: "$151,889", sub: "CA • 313 deals • Marge $45,585", type: "warning" },
    { label: "Mai 2026", value: "$103,409", sub: "CA • 350 deals • Marge $30,296 (hors SPY)", type: "primary" },
  ],
  ytdProductKPIs: [
    { label: "Digit Solution", value: "$573,358", sub: "Marge $215,345 (37.6%)", type: "primary" },
    { label: "SPY", value: "$119,850", sub: "Marge $13,390 (Jan→Avr, Mai N/A)", type: "success" },
    { label: "Comment/Trust", value: "$5,237", sub: "Marge $4,190", type: "warning" },
  ],
  ytdEvolutionData: [
    { name: "Janvier", ca: 134212, marge: 46992 },
    { name: "Février", ca: 150266, marge: 48220 },
    { name: "Mars", ca: 158668, marge: 61832 },
    { name: "Avril", ca: 151889, marge: 45585 },
    { name: "Mai", ca: 103409, marge: 30296 },
  ],
  ytdProductDistribution: [
    { name: "Digit Solution", value: 573358 },
    { name: "SPY", value: 119850 },
    { name: "Comment/Trust", value: 5237 },
  ],
  evolutionKPIs: [
    { label: "CA Total Growth", value: "-31.9%", sub: "-$48,480", detail: "Avr: $151,889 → Mai: $103,409 (hors SPY)", type: "warning" },
    { label: "Margin Growth", value: "-33.5%", sub: "-$15,289", detail: "Avr: $45,585 → Mai: $30,296", type: "warning" },
