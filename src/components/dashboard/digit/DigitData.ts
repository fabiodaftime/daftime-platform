...
const DIGIT_MAY = {
  ...
  ytdMainKPIs: [
    ...
    { label: "Marge Totale YTD", value: "$230,777", sub: "33.1% du CA" },
  ...
  ytdProductKPIs: [
    { label: "Digit Solution", value: "$573,358", sub: "Marge $213,268 (37.2%)", type: "primary" },
  ...
  evolutionKPIs: [
    ...
    { label: "Margin Growth", value: "-33.7%", sub: "-$15,413", detail: "Avr: $45,709 → Mai: $30,296", type: "warning" },
