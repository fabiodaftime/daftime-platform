...
const JAN_2026 = {
  ...
  consolidatedPL: [
    { label: 'Marge Nette Agency (après 50% Blink)', value: '$4,324', type: 'positive' },
    ...
    { label: 'MARGE BRUTE GROUPE', value: '$91,686', type: 'total-positive' },
    { label: '', value: '', type: 'spacer' },
    { label: 'Réserves Filiales (10%)', value: '-$9,169', type: 'negative' },
    { label: 'REMONTÉE HOLDING (90%)', value: '$82,517', type: 'total-positive' },
    { label: '', value: '', type: 'spacer' },
    ...
    { label: 'RÉSULTAT NET HOLDING', value: '$75,457', type: 'total-positive' },
    { label: '', value: '', type: 'spacer' },
    { label: 'Maxence (37.5%)', value: '-$28,296', type: 'negative' },
    { label: 'Thibault (37.5%)', value: '-$28,296', type: 'negative' },
    { label: '↳ dont Will', value: '$10,000', type: 'indent-muted' },
    { label: 'Florian (25%)', value: '-$18,865', type: 'negative' },
    { label: 'SALAIRES MANAGEMENT (100%)', value: '-$75,457', type: 'total-negative' },
    { label: '', value: '', type: 'spacer' },
    { label: 'SOLDE HOLDING', value: '$0', type: 'highlight' },
  ],
  pieData: [
    { name: 'Agency ($4.3K)', value: 4324, color: '#F59E0B' },
  ...
  // AGENCY TAB
  agencyKPIs: [
    { label: 'CA Brut', value: '$14,885', detail: 'Abo + Setup', color: 'navy' },
    { label: 'Marge Nette', value: '$8,648', detail: '58.1% du CA', color: 'green' },
    { label: 'Part PCA (50%)', value: '$4,324', detail: 'Après split Blink', color: 'gold' },
    { label: 'Total Charges', value: '$6,237', detail: '41.9% du CA', color: 'pink' },
  ],
  agencyComparison: null as PCGComparisonRow[] | null,
  agencyWaterfall: [
    { label: 'CA Brut', value: '$14,885', type: 'positive' },
    { label: '', value: '', type: 'spacer' },
    ...
    { label: '', value: '', type: 'spacer' },
    { label: 'MARGE NETTE (100%)', value: '$8,648', type: 'highlight' },
    { label: 'Part Blink (50%)', value: '-$4,324', type: 'negative' },
    { label: 'PART PCA (50%)', value: '$4,324', type: 'total-positive' },
  ],
  agencyRisks: [
    ...
    { label: 'Marge Nette', value: '58.1%', detail: 'vs 54.8% en Dec', severity: 'success' },
  ],
...
import { buildPCGroupMonthData } from './pcGroupAggregator';

// ----------------------------------------------------------------------------
// Per-month auto-build: each PCGroupMonthData is now produced by
// pcGroupAggregator.buildPCGroupMonthData() from the three sources
// (Agency / Structuring / Digit) + manual SPY/Comment/Holding values.
// The base object only carries bespoke per-entity tab strings; everything
// else (KPIs, pies, comparisons, YTD, reserves, intercos) is computed.
// ----------------------------------------------------------------------------

function applyComputedOverlay(month: MonthId, base: PCGroupMonthData): PCGroupMonthData {
  return buildPCGroupMonthData(month, base, PCG_MONTH_LABELS[month]);
}
