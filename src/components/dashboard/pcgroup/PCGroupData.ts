...
const FEB_2026 = {
  ...
  overviewComparisonTotal: { entity: 'MARGE BRUTE GROUPE', jan: '$89,607', feb: '$112,393', variation: '+25.4%', varType: 'positive', ytd: '$202,000' },
  entityCards: [
    { id: 'agency', name: 'Agency', badge: 'Media', gradient: 'linear-gradient(135deg, #4F5BD5 0%, #6366F1 100%)', cssClass: 'agency',
      metrics: [{ label: 'CA', value: '$35,080' }, { label: 'Marge Nette', value: '$12,237', colorClass: 'success' }], margin: 34.9, marginLevel: 'medium' as const },
    { id: 'structuring', name: 'Structuring', badge: 'Banking', gradient: 'linear-gradient(135deg, #1E3A5F 0%, #2D4A6F 100%)', cssClass: 'structuring',
      metrics: [{ label: 'CA', value: '$73,500' }, { label: 'Marge Nette', value: '$53,296', colorClass: 'success' }], margin: 72.5, marginLevel: 'high' as const },
    { id: 'digit', name: 'Digit Solution', badge: 'Ad Accounts', gradient: 'linear-gradient(135deg, #D946A8 0%, #EC4899 100%)', cssClass: 'digit',
    ...
    { id: 'comment', name: 'Comment', badge: 'Trust', gradient: 'linear-gradient(135deg, #10B981 0%, #059669 100%)', cssClass: 'comment',
      metrics: [{ label: 'CA', value: '$333' }, { label: 'Marge Nette', value: '$52', colorClass: 'success' }], margin: 15.6, marginLevel: 'low' as const },
  ],
  consolidatedPL: [
  ...
  ytdMonthlyTotal: { month: 'YTD TOTAL', ca: '$457,443', margin: '$202,000', taux: '44.2%', net: '$167,680' },
  ytdEntityTable: [
  ...
  ytdEntityTotal: { entity: 'TOTAL GROUPE', jan: '$89,607', feb: '$112,393', ytd: '$202,000', pct: '100%' },
  ytdTrendData: [
  ...
  reservesEntityTotal: { entity: 'TOTAL RÉSERVES', jan: '$8,961', feb: '$11,239', ytd: '$20,200' },
  reservesCards: [
