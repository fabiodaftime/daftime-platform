...
import { spyKPIs, spyWaterfall, spyCostsPie, spyAnalysis } from './PCGroupData';
  ...
  return (
    <div>
      ...
      <div className="pcg-charts-row">
        <PCGroupWaterfall data={spyWaterfall} title="💰 Waterfall SPY" />
        <div className="pcg-section">
          <div className="pcg-section-header">
            <h3 className="pcg-section-title">📊 Répartition des Coûts</h3>
          </div>
      ...
      <div className="pcg-section">
        <div className="pcg-section-header">
          <h3 className="pcg-section-title">⚠️ Analyse SPY</h3>
        </div>
        <div className="pcg-section-body">
