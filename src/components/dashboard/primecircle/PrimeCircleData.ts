...
const mayData: PCMonthData = {
  ...
  kpis: {
    totalCustomers: 42,
    totalTurnover: 56780,
    netProfit: 34261,        // 56 780 − Total costs 22 519 (OpEx 6 765 reclassées en Holding ; commission Sales corrigée à 3 366)
    netMarginRate: 60.3,
  ...
  m1Comparison: {
    ...
    netProfit: { prev: 38536, cur: 34261, diff: -4275, pct: -11.1, direction: 'negative' },
  ...
  monthlyComparison: [
    ...
    { month: 'March 2026', customers: 51, turnover: 55000, totalCosts: 25394, netProfit: 29606, netMarginRate: 53.8, varProfit: 40.7, varProfitDirection: 'positive' },
    { month: 'April 2026', customers: 50, turnover: 70875, totalCosts: 32339, netProfit: 38536, netMarginRate: 54.4, varProfit: 30.2, varProfitDirection: 'positive' },
    { month: 'May 2026', customers: 42, turnover: 56780, totalCosts: 22519, netProfit: 34261, netMarginRate: 60.3, varProfit: -11.1, varProfitDirection: 'negative' },
  ],
  costs: {
